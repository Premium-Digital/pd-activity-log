...
class Logger {
    ...
    private function __construct(
        ...
        $this->wpdb = $wpdb;
        $this->tableName = esc_sql($this->wpdb->prefix . 'pd_activity_log');
        $this->createTable();
    }

    public function isLoggingEnabled(): bool {
        return (bool) get_option('pd_activity_log_enabled', false);
    }
    ...
    private function createTable() {
        ...
        $sql = "CREATE TABLE {$this->tableName} (
            ...
            {$this->userId} BIGINT(20) UNSIGNED NOT NULL,
            {$this->userLogin} VARCHAR(60) NOT NULL,
    ...
    public function addLog(int $objectId, string $objectType, string $status = "update", int $userId = 0, string $userLogin = '', array $details = []) {
